    ...
    <div className="container contact-page">
      <div className="text-zone">
         <div className="lets-talk">
            ...
            <p>
              Me envia uma mensagem ali do lado!! <br/> Assim podemos agendar uma call para que eu
              possa contar um pouco mais sobre mim, meus objetivos e como posso agregar a sua companhia.
            </p>
          </div>
